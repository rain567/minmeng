...
<div class="center">
	<div class="content">
		<form action="${path }/safe/pass/checkCode" method="post" id="myForm">
			<dl>
				<dd class="l">
					<font color=red>*</font>手机号：
				</dd>
				<dd>
					<input type="text" class="text normal" name="mobilephone" value="${mobilephone }" />
...
$('#sendcode').click(function(){
	var _this = $(this);
	var url = '${path }/safe/pass/sendCode';
	var data = {"mobilephone":$('input[name="mobilephone"]').val()};
...
$('#myForm').form({
	 ...
	 success:function(data){
		...
		if(result.success){
			...
			window.location.href="${path}/safe/pass/resetpass?"+
